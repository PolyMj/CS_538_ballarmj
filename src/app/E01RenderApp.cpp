...
int main(int argc, char **argv) {
	...
	GLFWwindow* window = setupGLFW("E01RenderApp: ballarmj", 4, 3, windowWidth, windowHeight, DEBUG_MODE);
	...
	try {		
		...
		string vertexCode = readFileToString("./shaders/E01RenderApp/Quad.vs");
		string fragCode = readFileToString("./shaders/E01RenderApp/Quad.fs");
