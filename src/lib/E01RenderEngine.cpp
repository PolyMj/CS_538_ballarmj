...
E01RenderEngine::E01RenderEngine(int windowWidth, int windowHeight) {
...
void E01RenderEngine::renderToWindowTexture() {    
...
void E01RenderEngine::clearBuffer(unsigned char *buffer, 
                                    unsigned char r,
                                    unsigned char g,
                                    unsigned char b) {
...
void E01RenderEngine::drawOneFrame() {
...
void E01RenderEngine::drawAABox(  unsigned char* buffer,
                                    int sx, int sy, 
                                    int ex, int ey,
                                    unsigned char r,
                                    unsigned char g,
